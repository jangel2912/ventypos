var VendtyDemo = function () {

    // =========================================================================
    // SETTINGS APP
    // =========================================================================
    var adminCssPath = VendtyApp.handleBaseURL()+'/assets/admin/css';
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            //VendtyDemo.handleChooseThemes();
            VendtyDemo.handleNavbarColor();
            VendtyDemo.handleSidebarColor();
            //VendtyDemo.handleLayoutSetting();
            //VendtyDemo.handle
        },
