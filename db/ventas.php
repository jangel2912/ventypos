...
class Ventas extends CI_Controller {
    ...
    if (isset($_POST['vendedor'])) {
      ...
      if ($data_empresa['data']['tipo_factura'] == 'estandar') {
        ...
        $this->layout->template('ventas')
          ...
          ->js(array(base_url("/public/js/ventas.js?con=2"), base_url("/public/fancybox/jquery.fancybox.js"), base_url('public/js/plugins/multiselect/jquery.multi-select.js')))
  ...
  function eliminar_producto($venta, $id, $prod, $cant, $alm) {
  ...
  public function enviar_email($id) {
    ...
    $img = base_url("public/uploads/{$empresa['data']['logotipo']}");
...
';
 ...
 ';
    ...
    $pdf->Output("public/uploads/$pdf_name", 'F');

    $this->email->attach("public/uploads/$pdf_name");

    $this->email->send();

    unlink("public/uploads/$pdf_name");
