<div class="page-header">
    ...
    <h1><?php echo custom_lang("Ventas", "Ventas");?><small><?php echo $this->config->item('site_title');?></small></h1>
...
<div class="block title">
    ...
    <div class="head">
        ...
        <h2><?php echo custom_lang('sima_outstanding', "Listado de ventas");?></h2>                                          
    ...
    <div class="span12">
        ...
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('sima_outstanding_all', "Todas las ventas");?></h2>
                        ...
                        "mRender": function ( data, type, row ) {
                           ...
                           var buttons = "";
                            ...
                            <?php if(in_array('59', $permisos) || $is_admin == 't'):?>
                                ...
                                buttons += '<a title="Enviar por correo" href="<?php echo site_url("ventas/enviar_email/");?>/'+data+'" class="button blue"><div class="icon"><span class="ico-circle-arrow-right"></span></div></a>';
                            ...
                            <?php if(in_array('59', $permisos) || $is_admin == 't'):?>
                              ...
                              /*    console.log(row[6]);*/
                                if(row[6]=='clasico') 
                                buttons += '<a title="Ver pagos" href="<?php echo site_url("ventas/pagos_servicio/");?>/'+data+'" class="button yellow"><div class="icon"><span class="ico-dollar"></span></div></a>';
