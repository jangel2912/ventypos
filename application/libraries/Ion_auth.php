...

		{
...

			{
...

				{
					...
					$this->email->from($this->config->item('admin_email', 'ion_auth'), $this->config->item('site_title'));
...

		{
...

			{
				...
				//$message = $this->load->view($this->config->item('email_templates', 'ion_auth').$this->config->item('email_activate', 'ion_auth'), $data, true);
                                ...
                                $message = $this->opciones->get_activation(); 

                                $message = str_replace("[identidad]", $data['identity'], $message);

                                $message = str_replace("[vinculo]", anchor('auth/activate/'. $data['id'] .'/'. $data['activation'], "Haga clic aquí para verificar esta dirección de correo electrónico para su cuenta en VendTy"), $message);
				...
				$this->email->subject("Bienvenido a VendTy Apps!");
