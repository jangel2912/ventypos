...
*/
		         ...
		         ?>	 
                        <tr>
                            ...
                            <td  style="font-size: 10px" align="right">$ <?php echo number_format($p["precio_venta"]); ?></td>
                            <td style="font-size: 10px"  align="right"><?php echo $p['descuento']; ?></td> 
							<td style="font-size: 9px"  align="right">$ <?php echo number_format($total_column); ?></td>   
					    </tr>
                   <?php
                    } 
					else{  				 
		         ?>							
                        <tr>
                            ...
                            <td  style="font-size: 10px" align="left"><?php echo $p["unidades"] ?></td>
                            <td  style="font-size: 10px" align="right">$ <?php echo number_format($p["precio_venta"]); ?></td>
							<td style="font-size: 10px"  align="right">$ <?php echo number_format($total_column); ?></td>   
					    </tr>						
				   <?php
                    }
                    ?>		
   ...
   <?php  $total = $total_items + $timp; ?>          
		 ...
		 &nbsp;&nbsp; 	<b>Total a Pagar: </b>
			   ...
			   <td   align="right" >
				  $ <?php echo number_format($total_items) ?><br>		  
			  $ <?php echo number_format($timp) ?><br>
			  <?php  foreach ($data["detalle_pago_multiples"] as $p) { ?>
	...
	<?php   $formpago=str_replace("_"," ",$p->forma_pago);  ?>			  		  
		 <?php if($p->forma_pago!='efectivo'){  ?>  		  
			  <?php echo $p->valor_entregado; ?><br>
	    	   <?php } ?>	
          <?php if($p->forma_pago=='efectivo'){  ?>	
		  $  <?php echo number_format($p->valor_entregado) ?><br>
		  $  <?php echo number_format($p->cambio) ?><br>
            <?php } ?>	  	
