...
<html>
                      ...
                      $counter++;
                          if($data["tipo_factura"]=='clasico'){
                             ...
                             // $timp+=$imp;
                              ...
                              $preciototal+= $precioUnitario + $imp;
                              //nuevo
                              
                              // PRECIO de venta * $pv
                              
                              //precio con iva y las cantidades
                                $precioUnitariototal = $precioUnitario * $p['unidades'];
                              // sub-total - precio sin iva 
                                $precioUnitariototalsiniva += $pv * $p['unidades'];
                              // IVA total
                                $timp += $pv * ($p['impuesto'] / 100) * $p['unidades'];
                              //Descuento total
                                $descuentoTotal+=(($p['descuento']+ ($p['descuento']* ($p['impuesto'] / 100)))* $p['unidades']);
                                $total +=$precioUnitariototalsiniva+$timp;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="border-right: inset 1px #000000; font-size: 14px; padding:2px;" align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($precioUnitariototal); ?>&nbsp;</td>   
                            </tr> 
                    <?php
                    }
                    ?>
   ...
   <?php  $total = $precioUnitariototalsiniva + $timp - $descuentoTotal; ?>          
                  <table  width=818 style=" font-size: 11px" cellpadding="0" cellspacing="0">
                     <tr>
                          ...
                          <td valign="top" align="right" style="font-size: 14px; margin-right: 0px;">
                              <?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($precioUnitariototalsiniva) ?>  <br>      
                              <?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($timp) ?> <br>
                              <?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($descuentoTotal) ?> <br>
                              <?php foreach ($data["detalle_pago_multiples"] as $p) { ?>
                                  <?php 
