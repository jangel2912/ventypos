...
<?php if($data['data_empresa']['data']['vendedor_impresion'] == '3'){ ?>
 ...
 <?php  }   ?>          
                   ...
                   if($p["nombre_producto"] == 'PROPINA'){      
                    ...
                    /*    $pv = $p['precio_venta'];
                       ...
                       // $pvd = $precioUnitario - $desc;  
                        ...
                        $total_items += ($total_column);
                       // $valor_total = ($pvd * $p['unidades'] + $imp;       
                        $valor_total = round($total_items + $imp);      
                        
                                              
                        if($p['impuesto']==0){
                            $exentosImpueston+=$total_column;
                        }else{
                           $timp+=$imp;
                        }*/
                       ...
                       // $basen=$ci->opciones_model->redondear($pvd *  $p['unidades']);
                      //  $basent+=$pvd *  $p['unidades'];                        
                     ...
                     /*   echo "<br>desc=".$desc;
                       ...
                       // echo "<br>base=".$basen;
                        echo "<br>imp=".$imp;
                        echo "<br>total_column=".round($total_column);
                        echo "<br>valor_total=".round($valor_total);                      
                        echo "<br>IvaTotal2=".round($timp);*/
                        
                        //$imp =$precioUnitario
                       // $total_column = $pvd * $p['unidades'];
                     //   $total_column1 = $precioUnitario -$p['impuesto'] / 100;
    ...
    <?php
      ...
      /*  $valortotal=round($total);
        $bi=round($total_items+$timp);
  ...
  // }
  /*
   if($exentosImpueston >0){ 
  ?>
        <tr>

            <td colspan="4" style='text-align:right;'>Bienes exentos</td>

            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($exentosImpueston) ?></td>
