                ...
                <div id="ticket_wrapper">
                    ...
                    <div id="ticket_header">
                        ...
                        <table id="ticket_factura" align="center">
                            ...
                            <?php } ?>
                            <?php if( strlen(trim($data['venta']['cliente_provincia'])) > 0) { ?>
                                <div id="customer">Ciudad:<?php echo ' '.$data['venta']['cliente_provincia'] ?></div>
                            <?php } ?>
                            <?php if( isset($data['venta']['nombre_grupo']) && strlen(trim($data['venta']['nombre_grupo'])) > 0) { ?>
                                <div id="customer">Grupo:<?php echo ' '.$data['venta']['nombre_grupo'] ?></div>
                            <?php } ?>
                    ...
                    ?>	 
                        ...
                        <table id="ticket_items" align="left">
                            ...
                            foreach ($data["detalle_venta"] as $p) {
                                ...
                                <tr>
                                    ...
                                    <td class="pequeño" style='text-align:right;' colspan="2"><?php echo number_format($p["precio_venta"]); ?></td>
                                    <td class="pequeño" style='text-align:right;' ><?php echo number_format($p['descuento']); ?></td>
                                    <td class="pequeño" style='text-align:right;' colspan="2"><?php echo $data['data_empresa']['data']['simbolo']."<font color='#ffffff'>_</font>".number_format($valor_total); ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="pequeño" style='text-align:right;'colspan="2"><?php echo $data['data_empresa']['data']['simbolo']."<font color='#ffffff'>_</font>".number_format($p["precio_venta"]); ?></td>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td  class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($ci->opciones_model->redondear($total_items)) ?></td>
                      ...
                      ?>
                            <tr>
                                ...
                                <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($p->impuestos) ?></td>
                      ...
                      <?php	 
                       ...
                       ?>
                            ...
                            <tr>
                                ...
                                <td  class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($propina_final);  ?></td>
                     ...
                     $formpago=str_replace("_"," ",$p->forma_pago); 
                      if($p->forma_pago=='efectivo'){  ?>  
                                        <tr>
                                            ...
                                            <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($p->valor_entregado) ?>
                                            </td>
                    ...
                    <?php  foreach ($data["detalle_pago_multiples_cambio"] as $p) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($p->total_cambio) ?>
                                            </td>
                    ...
                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format($ci->opciones_model->redondear($total + $propina_final)); ?></td>
