                ...
                <br>
                  ...
                  <table  width="818" style="border: inset 1px #000000; border-bottom: inset 1px #000000;" cellpadding="0" cellspacing="0">
                      <tr>
                          ...
                          <th style="border: inset 1px #000000; font-size: 14px" align="center"><?php echo "Impuesto." ?></th>
...
*/
                        ...
                        ?>  
                            <tr>
                                ...
                                <td style="border-right: inset 1px #000000; font-size: 14px; padding:2px;" align="right"><?php echo $p['impuesto'] ?>&nbsp;</td>
                                <td style="border-right: inset 1px #000000; font-size: 14px; padding:2px;" align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p["precio_venta"]+($p["precio_venta"]*$p['impuesto'] /100)); ?>&nbsp;</td>
         ...
         <?php  
           ...
           ><?php
                ...
                <?php  $total = $total_items; ?>          
            <table  width=818 style=" font-size: 11px" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="font-size: 9px;  width: 65%;"></td>
                    <td valign="top" style="border-left: inset 0px #000000; width: 13%; font-size: 14px" align="right"><b><?php echo "Valor sin impuesto" ?></b></td>
                    <td  valign="top" align="right" style="font-size: 14px; margin-right: 0px;"><?php echo $data['data_empresa']['data']['simbolo'].'<span style="color:#fff">_</span>'.number_format($subtotal) ?></td>
                </tr>
                <?php
                foreach ($data["venta_impuestos"] as $p) {  
                    ...
                    <tr>
                        <td style="font-size: 9px;  width: 65%;"></td>
                        <td valign="top" style="border-left: inset 0px #000000; width: 13%; font-size: 14px" align="right" ><b><?php echo $p->imp ?></b></td>
                        <td valign="top" align="right" style="font-size: 14px; margin-right: 0px;"><?php echo $data['data_empresa']['data']['simbolo'].'<span style="color:#fff">_</span>'.number_format($p->impuestos) ?></td>
                    </tr>
                    <?php
                }
                ?> 
