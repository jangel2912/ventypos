                        ...
                        <tr>
                           <td>
                            ...
                            <td>
                                ...
                                <?php echo  $data['venta']["tipo_identificacion"].": ".$data['venta']["nif_cif"]?><br/>
                ...
                <table style="border-bottom: 2px dotted #000; text-align:center;">
                    ...
                    foreach ($data["detalle_venta"] as $p) {
                        ...
                        <tr>
                            ...
                            <td style='text-align:right;'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p["precio_venta"]); ?></td>
                            <td style='text-align:center;'><?php echo $data['data_empresa']['data']['simbolo'].' '.$p['descuento']; ?></td>
                            <td style='text-align:right;'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($total_column); ?></td>
                        </tr>
                        <?php
                    ...
                    <tr>
                        ...
                        <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($total); ?></td>
...
<?php foreach ($data["detalle_pago_multiples"] as $p) {
    ...
    <?php } ?>                    
                    ...
                    <tr>
                        <td>Total P.:<?php echo $total_productos_vendidos ?></td>
                        <td colspan="4"><br></td>
                ...
                <br/>
                 ...
                 <div align="center" style="padding-bottom:-10px; width: 95%">
