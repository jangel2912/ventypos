...
?>
<div id="ticket_wrapper" style="font-size: 6px">
    ...
    <div id="ticket_header">
        ...
        <div align="center">
            ...
            <?php if($data['data_empresa']['data']['nit'] != '900590001-2' && $data['data_empresa']['data']['nit'] != '6466096-9'){ ?>
                ...
                <div align="center" style=""><img src="<?php echo base_url("uploads/{$data['data_empresa']['data']['logotipo']}"); ?>" width="65" border="0" /></div>
            <?php } ?>
                <?php } ?>
        ...
        <table id="ticket_company" align="center">
            ...
            <tr>
                ...
                <td style=""><?php echo $data['venta']['direccion'] ?></td>

                <td style=""><?php echo $data['venta']['telefono'] ?></td>              
    ...
    <div align="center">
        <table id="ticket_items" align="center" style="padding-left: 2em">
            <tr>
        ...
        <table id="ticket_items">
            <tr>
                ...
                <th style="width:20%;text-align:right;" ><?php echo "Precio" ?></th>
                <th style="width:20%;text-align:right;" colspan="3"><?php echo "Total" ?></th>
            </tr>                
        <?php  }  ?>                   
        ...
        foreach ($data["detalle_venta"] as $p) {
            ...
            if($p["nombre_producto"] == 'PROPINA'){      
                ...
                ?> 
                    ...
                    <tr>
                    <td style="width:25%;"><?php echo $p["codigo_producto"]; ?></td>
                    <td style='width:25%;text-align:center;'><?php echo $p["unidades"]; ?></td>
                    <td style='width:25%;text-align:right;' ><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p['precio_venta']); ?></td>
                    <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ci->opciones_model->redondear($valor_total)); ?></td>
                </tr>               
            <?php
                }
            ?> 
        ...
        <tr>
            <td colspan="3" style='width:50%;text-align:right;' align="right"><?php echo "Valor sin impuesto" ?></td>
            <td  style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ci->opciones_model->redondear($total_items)) ?></td>
        </tr>

        <tr>
            <td colspan="3" style='width:50%;text-align:right;' align="right">IVA</td>
            <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($timp) ?></td>
        </tr>
        ...
        <?php if($sobrecosto > 0 && $propina_final > 0){ ?>
            <tr>
                <td colspan="3" style='width:50%;text-align:right;' align="right"><?php echo "Propina" ?></td>
                <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($propina_final);  ?></td>
            </tr>
        <?php } ?>
        ...
        <?php foreach ($data["detalle_pago_multiples"] as $p) { ?>
            ...
            if($p->forma_pago=='efectivo'){  ?>  
                <tr>
                    <td colspan="3" style='width:50%;text-align:right;' align="right"><?php echo ucfirst($formpago) ?></td>
                    <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p->valor_entregado) ?>
                    </td>
                </tr>         
            <?php } ?> 
        ...
        <?php  foreach ($data["detalle_pago_multiples_cambio"] as $p) { ?>
            <tr>
                <td colspan="3" style='width:50%;text-align:right;' align="right"><?php echo "Cambio" ?></td>
                <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format( round( $p->total_cambio,-1) ) ?></td>
            </tr>    
        <?php } ?>

        <?php  //$total = $total_items + $timp; ?> 
            <tr>
                <td colspan="3" style='width:50%;text-align:right;' align="right"><?php echo "Total venta" ?></td>
                <td style='width:25%;text-align:right;' colspan="3"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format( $ci->opciones_model->redondear( $total + $propina_final) ); ?></td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
    ...
    <div align="center"><?php echo  $data['data_empresa']['data']['resolucion'];//nl2br($data['resolucion']); ?></div>
        ...
        <?php if($data['venta']['factura_electronica'] === '1') { ?>
        <div align="center">
            <?php
            
            sleep(20);
            //$responseRGrafica = get_curl('electronic-invoicing/representacionGrafica/'.$id, $this->session->userdata('token_api') );
            $responseRGrafica = get_curl('request/'.$data['venta']['id_venta'], $this->session->userdata('token_api'));
            $output_file = "uploads/imageQr".$data['venta']['factura'].".png";
            // open the output file for writing
            $ifp = fopen( $output_file, 'wb' );
            // we could add validation here with ensuring count( $data ) > 1
            fwrite( $ifp, base64_decode( $responseRGrafica->qr ) );
            // clean up the file resource
            fclose( $ifp );
            echo '<img height="100" width="100" src="'.$output_file.'" />';
            ?>
        </div>
        <br />
        <?php } ?>
