    ...
    <table id="ticket_items">
               ...
               // ROUND((SELECT dummy1 *(porcentaje_descuento)/100)),         
                ...
                if($descuento_general != 0){  
                    ...
                    if($p['impuesto']!=0){
                        ...
                        if($impn== 1){
                            $im='1.0'.$p['impuesto'];     
                            $basen=((($precio_venta - $descuento_prod) *  $p['unidades']) / $im); 
                        ...
                        $exentosImpueston=(($precio_venta - $descuento_prod) *  $p['unidades']);
                    }
                }else{
                ...
                //iva        
                   /*
                echo"<br><br>precio_venta=".$precio_venta;
                echo"<br>descuento_general=".$descuento_general;
                echo"<br>porcentaje_descuentop=".$porcentaje_descuentop;
                echo"<br>descuento_prod=".$descuento_prod;
                echo"<br>basen=".$basen;
                echo"<br>ivan=".$ivan;
                echo"<br>exentosImpueston=".$exentosImpueston;
                echo"<br><br>";
                */
       ...
       // print_r($productos);
        ...
        <tr><td colspan="4">&nbsp;</td></tr>
           ...
           /* echo"<br>basent=".$basent;
        echo"<br>ivant=".$ivant;
        echo"<br>exentosImpuestont=".$exentosImpuestont;*/
            ?>
            <!--<td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].$ci->opciones_model->formatoMonedaMostrar($subtotal) ?></td>-->
            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].$ci->opciones_model->formatoMonedaMostrar($basent) ?></td>
        </tr>
        <tr>
            <?php 
            ...
            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].$ci->opciones_model->formatoMonedaMostrar(($ivant)) ?></td>
        </tr>
  <?php
    if($exentosImpuesto != 0)
    {
        ...
        <tr>
            ...
            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].$ci->opciones_model->formatoMonedaMostrar($exentosImpuestont) ?></td>
        </tr>
        <?php
    }
   ?>
