                ...
                <div id="ticket_wrapper">
                    ...
                    ?>	 
                        <table id="ticket_items" >
                            ...
                            <tr>
                                ...
                                <th class="pequeño" style="width:20%;text-align:right;" colspan="2"><?php echo "Precio" ?></th>
                                <th class="pequeño" style="width:20%;text-align:right;"><?php echo "Desc" ?></th>
                                <th class="pequeño" style="width:20%;text-align:right;" colspan="2"><?php echo "Total" ?></th>
                            </tr>
                                               <?php  
                                                       }	  
                                                             else{  				 
                        ...
                        <table id="ticket_items" align="left">
                            ...
                            <tr>
                                ...
                                <th class="pequeño" style="width:40%;text-align:right;" colspan="2"><?php echo "Precio" ?></th>   
                                
                                <th class="pequeño" style="width:40%;text-align:right;" colspan="2"><?php echo "Total" ?></th>
                            ...
                            foreach ($data["detalle_venta"] as $p) {
                                    $total_productos_vendidos+=$p['unidades'];
                                ...
                                ?>
                                      ...
                                      <?php  
                                             ...
                                             ?>	 
                                <tr>
                                    <td class="pequeño" colspan="6"><?php echo $p["nombre_producto"] ?></td>
                                </tr>
                                <tr>
                                    <td class="pequeño" style='text-align:center;'><?php echo $p["unidades"]; ?></td>
                                    <td class="pequeño" style='text-align:right;' colspan="2"><?php echo number_format(($p["precio_venta"]), $decimales_moneda); ?></td>
                                    <td class="pequeño" style='text-align:right;' ><?php echo number_format(($p['descuento']), $decimales_moneda); ?></td>
                                    <td class="pequeño" style='text-align:right;' colspan="2"><?php echo $data['data_empresa']['data']['simbolo']."<font color='#ffffff'>_</font>".number_format(($valor_total), $decimales_moneda); ?></td>
                                </tr>
                                <tr><td class="pequeño" colspan="6">&nbsp;</td></tr>
                                       <?php
                                        } 
                                                            else{  				 
                                             ?>	
                                ...
                                <tr>
                                    ...
                                    <td class="pequeño" style='text-align:right;'colspan="2"><?php echo $data['data_empresa']['data']['simbolo']."<font color='#ffffff'>_</font>".number_format(($p["precio_venta"]), $decimales_moneda); ?></td>
                                    
                                    <td class="pequeño" style='text-align:right;'colspan="2"><?php echo $data['data_empresa']['data']['simbolo']."<font color='#ffffff'>_</font>".number_format(($valor_total), $decimales_moneda); ?></td>

                                </tr>
                                <tr><td class="pequeño" colspan="5">&nbsp;</td></tr>
                                                       <?php
                                        }
                                        ?>	
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td  class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($ci->opciones_model->redondear($total_items)), $decimales_moneda) ?></td>
                      ...
                      ?>
                            <tr>
                                ...
                                <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($p->impuestos), $decimales_moneda) ?></td>
                      ...
                      <?php	 
                       ...
                       ?>
                            ...
                            <tr>
                                ...
                                <td  class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($propina_final), $decimales_moneda);  ?></td>
                     ...
                     $formpago=str_replace("_"," ",$p->forma_pago); 
                      if($p->forma_pago=='efectivo'){  ?>  
                                        <tr>
                                            ...
                                            <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($p->valor_entregado), $decimales_moneda) ?>
                                            </td>
                    ...
                    <?php  foreach ($data["detalle_pago_multiples_cambio"] as $p) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($p->total_cambio), $decimales_moneda) ?>
                                            </td>
                    ...
                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <td class="pequeño" style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo']."<font color='#fdfefe'>_</font>".number_format(($ci->opciones_model->redondear($total + $propina_final)), $decimales_moneda); ?></td>

                            </tr>
                            <tr>
                                <td class="pequeño" style='text-align:right;'>Total P.: <?php echo $total_productos_vendidos;  ?> </td>
                    ...
                    //puntos --------------------------------------------------------------------------------------------------------------------------
                            ...
                            ?>
                            Puntos por esta factura: <?php  echo number_format(($data["puntos_cliente_factura"]), $decimales_moneda); ?><br/>
                                    Puntos Acumulados: <?php  echo number_format(($data["puntos_cliente_acumulado"]), $decimales_moneda); ?>
                            <?php 
                                            }		  
                    //puntos --------------------------------------------------------------------------------------------------------------------------
                            ?>
