                  ...
                  <!--<div align="center"><img src="logo_ticket.jpg" width="338" height="114" border="0" /></div>-->
                    ...
                    <table style="border-left: 1px inset #000000; border-right: 1px inset #000000; border-top: 1px inset #000000; border-bottom: 0px solid red;"  width=818>
                      <tr>                         
                        ...
                        <?php if(!empty($data['venta']['vendedor'])){ ?>
                        <td>&nbsp;&nbsp;
                         <?php echo "<b>Vendedor: </b> " . $data['venta']['vendedor'] ?>
                        </td>
                        <?php }?>
                        <td>&nbsp;&nbsp;
...
*/
		         ...
		         ?>	 
                        <tr>
                            ...
                            <td style="font-size: 10px"  align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p['descuento']);?></td> 
							<td style="font-size: 9px"  align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($total_column); ?></td> 
                            <!--<td style="font-size: 9px"  align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($totalp); ?></td>   -->
					    </tr>
                   <?php
                    } 
					else{  				 
...
<?php if($data['detalle_pago']['forma_pago']=='efectivo'){  ?>	 
		 ...
		 &nbsp;&nbsp; 	<b>Total a Pagar: </b>
               ...
               <!--
               <?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($basent) ?><br>		  
			   <?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ivant) ?><br>-->
		 <?php if($data['detalle_pago']['forma_pago']!='efectivo'){  ?>  		  
