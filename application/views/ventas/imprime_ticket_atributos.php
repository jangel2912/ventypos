        ...
        foreach ($data["detalle_venta"] as $p) {
            ...
            ?>
                  ...
                  <?php  
					 if($i == 1){  				 
		         ?>	 
            <tr><td colspan="5"><?php echo substr($p["nombre_producto"], 0, 28); ?></td></tr>
...
<?php  foreach ($data["detalle_pago_multiples"] as $p) { ?>
 ...
 <?php if($p->forma_pago=='efectivo'){  ?>  
                    ...
                    <tr>
                        ...
                        <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p->cambio) ?>
                        </td>
...
<?php } ?>
        ...
        <tr>
            <td style='text-align:left;'>total P.:<?php echo $total_productos_vendidos ?></td>
            <td colspan="4">&nbsp;</td>
