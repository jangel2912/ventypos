                ...
                <div id="ticket_wrapper">
                        ...
                        foreach ($data["detalle_venta"] as $p) {
                                ...
                                if($p["nombre_producto"] == 'PROPINA'){      
                                    ...
                                    if($data["tipo_factura"]=='clasico'){
                                        ...
                                        $total = $precioUnitariototalsiniva + $timp - $descuentoTotal; 
                                ...
                                <td style='text-align:right;'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ci->opciones_model->redondear($precioUnitariototal)); ?></td>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ci->opciones_model->redondear($precioUnitariototalsiniva)) ?></td>
                        </tr>               
                        <tr>
                        ...
                        <tr>
                            ...
                            <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($descuentoTotal) ?></td>
                        </tr>
