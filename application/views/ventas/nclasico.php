                                    ...
                                    <tbody id="detalle">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="descuento" id="descuento" class="discount" value="0"/>
										      	<input type="hidden" name="discount_final" id="discount_final" class="discount_final" value="0"/>
...
//
        ...
        $(".add").click(function(e){
            ...
            if(!flag_errors){
                ...
                var html = '<tr id="last"><td width="10"><input type="hidden" name="product_id[]" id="product_id" class="product_id"  value="'+$('#id_producto').val()+'"/><input type="hidden" name="codigo" class="codigo" id="codigo" value="'+$('#codigo').val()+'"></td><td><input type="hidden" name="product_name[]" class="product-service" value="'+$("#product-service").val()+'" id="product_name"/>'+$("#product-service").val()+'</td><td><textarea name="description[]" class="description">'+$("#descripcion").val()+'</textarea></td><td><input type="text" name="quantity[]" class="quantity" value="'+$("#cantidad").val()+'" id="cantidad"/></td><td><input style="text-align:right" value="'+$("#precio").val()+'" type="text" class="psi" name="psi[]"/></td><td><input type="text" name="discount[]" class="discount" id="discount" value="'+$("#descuento").val()+'"/><input type="hidden" name="discount_final[]" class="discount_final" id="discount_final" value="'+$("#discount_final").val()+'"/></td><td><input type="hidden" name="impuesto[]" class="impuesto" id="'+$("#cantidad").val()+'_'+$("#product-service").val()+'" value="'+$("#impuestos").val()+'"><input type="text"  value="'+$("#impuestos option:selected").html()+'" readonly="readonly"></td><td style="text-align:right" class="ptotal">'+ '' +'</td><td><a  class="button red delete" title="Eliminar" href="#"><div class="icon"><span class="ico-remove"></span></div></td></td></tr>';
        ...
        function calculate(){
            ...
            $(".psi").each(function(x){
				...
				discount_final = ( (psi) * discount / 100);
				...
				$(".discount_final").eq(x).val(discount_final);
		   ...
		   document.getElementById("enviar_factura").disabled = true;
            ...
            $(".psi").each(function(x){
                ...
                productos_list[x] = {
                    ...
                    , 'descuento': parseInt($(".discount_final").eq(x).val())
