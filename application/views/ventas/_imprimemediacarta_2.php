            ...
            <div id="print_area" >
                ...
                <table style="border-bottom: 2px dotted #000; text-align:center;">
                    <tr style="border-bottom: 2px solid #000;">
                        <th width="35%"><?php echo "Descripción" ?></th>
                        <th width="10%"><?php echo "Cant" ?></th>
                        <th width="20%"><?php echo "Precio" ?></th>
                        <th width="15%"><?php echo "Descuento" ?></th>
                    ...
                    foreach ($data["detalle_venta"] as $p) {
                        ...
                        if($data["tipo_factura"]=='clasico'){
                            ...
                            $valor_unitario = $pvd + $pvd * $p['impuesto'] / 100 ;
                        ...
                        <tr>
                            ...
                            <td style='text-align:right;'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($valor_unitario); ?></td>
...
<?php if($data['detalle_pago']['forma_pago']=='efectivo'){  ?>
                    ...
                    <tr>
                        ...
                        <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($data['detalle_pago']['valor_entregado']) ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($data['detalle_pago']['cambio']) ?>
                        </td>
