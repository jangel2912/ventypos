    ...
    <body>
        ...
        <div id="contenedor">
            ...
            <div id="print_area">
                ...
                <?php
                    if (isset($data['trilla'])&&($data['trilla'])){
                        $this->load->view("ventas/_imprimecondecimales_factura_electronica.php", array('data' => $data));
                    }
                    else{
                        $this->load->view("ventas/_imprime_factura_electronica.php", array('data' => $data));
                    }                    
