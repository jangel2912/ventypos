    ...
    <table id="ticket_items">
        ...
        foreach ($data["detalle_venta"] as $p) {
            ...
            <tr>
                ...
                <td style='text-align:right;'><?php echo number_format($ci->opciones_model->redondear($p["precio_venta"])); ?></td>

                <td style='text-align:center;'><?php echo number_format($ci->opciones_model->redondear($p['descuento'])); ?></td>
            ...
            <tr>
                ...
                <td style='text-align:right;' colspan="2"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($ci->opciones_model->redondear($p["precio_venta"])); ?></td>
...
<?php  foreach ($data["detalle_pago_multiples_cambio"] as $p) { ?>
                    ...
                    <tr>
                        ...
                        <td  style='text-align:right'><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format( $ci->opciones_model->redondear($p->total_cambio)); ?> </td>
