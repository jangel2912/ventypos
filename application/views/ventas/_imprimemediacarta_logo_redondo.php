                  ...
                  <!--<div align="center"><img src="logo_ticket.jpg" width="338" height="114" border="0" /></div>-->
                        ...
                        <tr>
                            ...
                            <td width="20%" align="right">
                                  <?php if(!empty($data['data_empresa']['data']['logotipo'])) : ?>
                                    <img width="105px" height="105px" src="<?php echo base_url("uploads/{$data['data_empresa']['data']['logotipo']}");?>" />
                                <?php endif; ?>                            
                          </td>
                        <tr>  
                  </table>
                    ...
                    <table style="border-left: 1px inset #000000; border-right: 1px inset #000000; border-top: 1px inset #000000; border-bottom: 0px solid red;"  width=818>
                      <tr>                         
						...
						<?php 
						if($data['venta']['fecha'] != $data['venta']['fecha_vencimiento_venta']){
                   ...
                   <table  width=818 style="border-left: 1px inset #000000; border-right: 1px inset #000000; border-top: 1px inset #000000; border-bottom: 0px solid red; ">
                     ...
                     <tr>
					  ...
					  <td><?php echo "<B>Celular Cliente:</B> ".$data['venta']["cliente_movil"]; ?></td>				  
                     </tr>
                    <tr>
                     <td width="48%"></td>
					  <td></td>	
...
*/
		         ...
		         ?>	 
                        <tr>
                            <td  style="font-size: 12px" align="left"><?php echo $p["codigo_producto"] ?></td>						
                            <td  style="font-size: 12px" align="left"><?php echo $p["nombre_producto"] ?></td>
                            <td  style="font-size: 12px" align="left"><?php echo $p["unidades"] ?></td>
                            <td  style="font-size: 12px" align="right"><?php echo $data['data_empresa']['data']['simbolo'].' '.number_format($p["precio_venta"]); ?></td>
                            <td style="font-size: 12px"  align="right"><?php echo $p['descuento']; ?></td> 
   ...
   <?php  $total = $total_items + $timp; ?>          
                   ...
                   <tr>
                     <td style="border-right: inset 1px #000000; width: 15%;" align="center"  valign="bottom">____________________<br><B>FIRMA DEL CLIENTE</B></td>	
                     <td style="font-size: 9px;  width: 50%;"><?php echo $data['data_empresa']["data"]['terminos_condiciones'];?></td>
                     <td style="border-left: inset 1px #000000; width: 16%; font-size:14px;" align="left" >
