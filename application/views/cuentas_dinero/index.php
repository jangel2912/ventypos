<div class="page-header">
    ...
    <h1><?php echo custom_lang("Contactos", "Cuentas de dinero");?><small><?php echo $this->config->item('site_title');?></small></h1>
...
<div class="block title">
    ...
    <div class="head">
        ...
        <h2><?php echo custom_lang('sima_provider_list', "Listado de Cuentas de dinero");?></h2>                                          
        ...
        <div class="block">
            ...
            <?php $permisos = $this->session->userdata('permisos');
                ...
                if(in_array("46", $permisos) || $is_admin == 't'):?>
                 ...
                 <a href="<?php echo site_url("cuentas_dinero/nuevo")?>" class="btn"><small class="ico-plus icon-white"></small> <?php echo custom_lang('sima_new_sales_man', "Nueva Cuenta de dinero");?></a>
         ...
         <!--   <a href="#" class="btn" id="add-new-provider"><small class="ico-plus icon-white"></small> <?php echo custom_lang('sima_new_provider_fast', "Nuevo proveedor(Rápido)");?></a>
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('sima_all_provider', "Todos las Cuentas de dinero");?></h2>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       oTable = $('#proveedoresTable').dataTable( {
                ...
                "aaSorting": [[ 3, "desc" ]],
                "sAjaxSource": "<?php echo site_url("cuentas_dinero/get_ajax_data");?>",
                        ...
                        "mRender": function ( data, type, row ) {
                                ...
                                var buttons = "";
                                 ...
                                 <?php if(in_array('47', $permisos) || $is_admin == 't'):?>
                                    ...
                                    buttons += '<a href="<?php echo site_url("cuentas_dinero/editar/");?>/'+data+'" class="button green"><div class="icon"><span class="ico-pencil"></span></div></a>';
