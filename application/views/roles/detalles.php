<div class="page-header">
    ...
    <h1><?php echo custom_lang("product_detail", "Detalles de productos");?><small><?php echo $this->config->item('site_title');?></small></h1>
</div>
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('product_detail', "Detalles de productos");?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('product_detail', "Detalles del producto");?></h2>
            </div>
                <div class="data-fluid">
                    <dl class="dl-horizontal">
                        ...
                        <dt><?php echo custom_lang('price_of_purchase', "Precio de compra");?></dt>
                        <dd><?php echo $data['precio_compra']?></dd>
