...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('sima_outstanding', "Listado de facturas pendientes");?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('sima_outstanding_all', "Todas las facturas pendientes");?></h2>
            </div>
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="facturasTable">
                        <thead>
                            <tr> 
                                ...
                                <th width="10%"><?php echo custom_lang('sima_total_price', "Precio total");?></th>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#facturasTable').dataTable( {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "<?php echo site_url("facturas/get_ajax_data");?>",
                "sPaginationType": "full_numbers",
                "iDisplayLength": 10, "aLengthMenu": [5,10,25,50,100],
                "aoColumnDefs" : [
                    { "bSortable": false, "aTargets": [ 3 ], "bSearchable": false, "mRender": function ( data, type, row ) {
                            return row[2] - row[3];
                    }},
