<div class="page-header">
    ...
    <h1><?php echo custom_lang("Contactos", "Categorías del Cierres de Cajas");?><small><?php echo $this->config->item('site_title');?></small></h1>
        ...
        <div class="block">
         ...
         <!--   <a href="#" class="btn" id="add-new-provider"><small class="ico-plus icon-white"></small> <?php echo custom_lang('sima_new_provider_fast', "Nuevo proveedor(Rápido)");?></a>
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('sima_all_provider', "Categorías del Cierres de Cajas");?></h2>
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="proveedoresTable">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><?php echo custom_lang('sima_name_comercial', "Fecha");?></th>   
								
                                <th><?php echo custom_lang('sima_name_comercial', "Nombre caja");?></th>   															

                                <th><?php echo custom_lang('sima_name_comercial', "Hora de movimiento");?></th>                                

                                <th><?php echo custom_lang('sima_name_comercial', "Tipo de movimiento");?></th>
