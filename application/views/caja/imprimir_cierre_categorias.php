    ...
    <div id="ticket_header">
        ...
        <table id="ticket_items" >
            ...
            <tbody>
                ...
                <tr>
                    <td align="left"><?php echo $cierre_producto_item[7] ?></td>
                    <td><?php echo $cierre_producto_item[6] ?></td>
                    <td><?php echo number_format($cierre_producto_item[8]) ?></td>
                </tr>
                            <?php $cantidad_factura = $cantidad_factura + $cierre_producto_item[6] ?>
                            <?php $total_factura = $total_factura + $cierre_producto_item[8] ?>
                        <?php } ?>
                    <?php } ?>
            </tbody>
            <tfoot>
