...
<div class="row-fluid">
    ...
    <div class="block"><?php //echo validation_errors(); ?>
        ...
        <div class="data-fluid">
            ...
            <div class="alert alert-success" id='mensaje-producto' ></div>
        ...
        <div class="block">
            ...
            <div class="data-fluid">
                ...
                <div class="row-form">
                    ...
                    <div class="span2"><input type="text" value="<?php echo set_value('precio'); ?>" name="precio" placeholder=""/>
    ...
    $("#ajaxform").submit(function(e)
    {
        ...
        $.ajax(
        {
            ...
            success:function(data, textStatus, jqXHR) 
            {
                ...
                if(data.success){
                    $('#mensaje-producto').html('Producto creado con exito.');
                }else{
                    $('#mensaje-product0').html('No se creo el producto, vuelva a intentarlo.');
                }
    ...
    $(document).ready(function(){
        ...
        $(".add").click(function(e){
            ...
            if(!flag_errors){
                ...
                var html = '<tr>'+
                                ...
                                '<td><input type="hidden" name="product_name[]" class="product-service" value="'+$("#product-service").val()+'" id="product_name"/>'+$("#product-service").val()+'</td>'+
                                ...
                                '<td><select name="impuesto[]" class="impuesto" id="'+$("#cantidad").val()+'_'+$("#product-service").val()+'"><?php foreach($data['impuestos'] as $key => $value){ echo '<option value="'.$key.'">'.$value.'</option>';}?></select></td>'+
                ...
                console.log($("#impuestos").val());

                $("#detalle").append(html);

               impuesto_index = document.getElementById($("#cantidad").val()+'_'+$("#product-service").val());
               impuesto_index.selectedIndex = document.getElementById("impuestos").selectedIndex;
               console.log(document.getElementById("impuestos").selectedIndex);
        ...
        function calculate(){
            ...
            $(".psi").each(function(x){
                ...
                cantidad = psi * quantity; //cantidad por precio unidad

                suma_row = cantidad - (cantidad * (discount/100));

               
                suma += suma_row;

                impuesto_row =  quantity * (impuesto / 100);                        

                iva += impuesto_row;

                $(".ptotal").eq(x).text( suma_row +(suma_row * impuesto_row ));
                total_iva += (suma_row * impuesto_row);
                total_sin_iva += suma_row;
                total_con_iva += suma_row +(suma_row * impuesto_row);
            ...
            $(".total_siva").html( limpiarCampo(total_sin_iva)/*.toFixed(2)*/);

            $(".iva").html( limpiarCampo(total_iva)/*.toFixed(2)*/ );

            $(".total_civa").html( limpiarCampo(total_con_iva)/*.toFixed(2)*/);

            //input hidden

            $("#input_total_siva").val(limpiarCampo(total_sin_iva)/*.toFixed(2)*/);

            $("#input_iva").val(limpiarCampo(total_iva)/*.toFixed(2)*/);

            $("#input_total_civa").val(limpiarCampo(total_con_iva)/*.toFixed(2)*/);
