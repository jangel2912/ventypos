...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('sima_new_category', "Editar Sección"); ?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <?php echo form_open_multipart("secciones_almacen/editar/".$datos_seccion->id, array("id" => "f_validate")); ?>
    <div class="row-form">
     <div class="form-group">
       <div class="col-xs-12">
           ...
           <div class="col-sm-4">
               <input type="text"  value="<?php echo $datos_seccion->codigo_seccion; ?>" placeholder="" name="codigo" />
         ...
         <div class="col-sm-4">
             <input type="text"  value="<?php echo $datos_seccion->nombre_seccion; ?>" placeholder="" name="nombre" />
 ...
 <div class="row-form">
    <div class="form-group">
        <div class="col-xs-12">
            ...
            <div class="col-sm-4">
                <select name="almacen">
                    ...
                    <?php foreach ($data['almacenes'] as $key => $value) { 
                            $selected = '';
                            if($value->id == $datos_seccion->id_almacen){
                                $selected = 'selected';
                            }
                        ?>
            ...
            <label class="col-sm-2 control-label">
                <?php echo custom_lang('sale_almacen', "Descripcion"); ?>:
            </label>
            <div class="col-sm-4">
                <textarea name="descripcion"><?php echo $datos_seccion->descripcion_seccion;?></textarea>
