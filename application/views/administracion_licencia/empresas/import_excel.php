...
<div class="block title">
    ...
    <div class="head">
        ...
        <h2><?php echo custom_lang('sima_poviders_import', "Importar Empresas desde excel");?></h2>                                          
                ...
                <?php endif; ?>
                        ...
                        <?php echo validation_errors(); ?>
                            ...
                            <div class="data-fluid">
                                ...
                                <?php echo form_open_multipart("administracion_vendty/empresas/import_excel", array("id" =>"validate"));?>
