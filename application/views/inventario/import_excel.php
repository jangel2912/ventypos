...
<?php echo form_open_multipart("inventario/import_excel", array("id" =>"validate"));?>
...
<div class="row-fluid">
    <div class="block">
        ...
        <h5>2. Abra el archivo Plantilla Invetario que descargo a su computador y comience a ingresar el codigo que tiene el producto la cantidad y el precio de compra</a>.</h5> 	                                        
       <img src="<?php echo base_url("/public/img/");?>/csv_inventario_1.png" width="800px" />
