...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('sima_new_tamano', "Nuevo tamaño de producto"); ?></h2>                                          
    </div>
</div>

<div class="row-fluid">
    <?php echo form_open_multipart("tamanos_productos/insertar", array("id" => "f_nuevo_tamano_producto")); ?>
	<div class="row-form">
     <div class="form-group">
       <div class="col-xs-12">
           ...
           <div class="col-sm-4">
               <input type="text"  value="<?php echo set_value('nombre_tamano'); ?>" placeholder="" name="t_nombre_tamano" />
         ...
         <div class="col-sm-4">
             <select name="s_categorias_prducto[]" id="s_categorias_prducto" multiple="multiple">
             	<?php foreach ($categorias as $key => $una_categoria) { ?>
             		<option value="<?php echo $una_categoria->id ?>"><?php echo $una_categoria->nombre ?></option>	
             	<?php } ?>
             </select>
     ...
     <div class="form-group">
       <div class="col-xs-12">
           ...
           <div class="col-sm-4">
           <textarea name="ta_descripcion_tamano"><?php echo set_value('descripcion_tamano'); ?></textarea>
...
<script>
    $(document).ready(function(){ 
    	...
    	$("#f_nuevo_tamano_producto").submit(function(e){
            e.preventDefault();
            enviar_formulario();
        });
    });
    ...
    function enviar_formulario(){
	    ...
	    $.ajax({
	        url: $("#f_nuevo_tamano_producto").attr('action'),
	        type: 'POST',
	        dataType: 'json',
	        data: $("#f_nuevo_tamano_producto").serialize(),
	        beforeSend: function(){
