...
<div class="page-header">
    ...
    <h1><?php echo custom_lang("Informes", "Informe de Clientes");?></h1>
</div>
<div class="row-fluid">
    <div class="span12">
        <div class="block">
        ...
        $is_admin = $this->session->userdata('is_admin');
         $username = $this->session->userdata('username');
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('ventasxclientes', "Listado de clientes");?></h2>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        oTable = $('#suscripcionesTable').dataTable( {
            "bProcessing": true,
            "sAjaxSource": "<?php echo site_url('administracion_vendty/distribuidores/get_ajax_data_suscripciones');?>",
        ...
        $("<div id='suscripcionesTable_length4' class='dataTables_length'><label><select id='vendedor' class='selectpicker' data-live-search='true'><?php echo $vendedores;?></select></label></div>").insertAfter('#suscripcionesTable_length3');
        ...
        $("#filtrar").click(function(){
            ...
            oTable.fnReloadAjax( "<?php echo site_url("administracion_vendty/distribuidores/get_ajax_data_suscripciones");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin+"&tipo_plan="+tipo_plan+"&vendedor="+vendedor );
        });
