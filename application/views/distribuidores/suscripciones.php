<div class="page-header">
    ...
    <h1><?php echo custom_lang("Informes", "Clientes");?></h1>
</div>
<div class="row-fluid">
    ...
    <div class="span12">
        ...
        $is_admin = $this->session->userdata('is_admin');
         $username = $this->session->userdata('username');
            ...
            <a class="btn btn-success" id="btn_ex_ventas_dia" href="<?php echo site_url().'/administracion_vendty/distribuidores/nueva_suscripcion';?>" />Nuevo cliente</a>
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="suscripcionesTable">
                        <thead>
                            <tr>
                                ...
                                <th width="15%"><?php echo custom_lang('sima_sales', "Pais");?></th>
                                <th width="15%"><?php echo custom_lang('sima_sales', "Ciudad");?></th>
                                <th width="15%"><?php echo custom_lang('sima_sales', "Tipo negocio");?></th>
