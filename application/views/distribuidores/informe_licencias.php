...
<div class="page-header">
    ...
    <h1><?php echo custom_lang("Informes", "Informe de Licencias");?></h1>
</div>
<div class="row-fluid">
    <div class="span12">
        <div class="block">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#filtrar").click(function(){
            ...
            oTable.fnReloadAjax( "<?php echo site_url("administracion_vendty/distribuidores/get_ajax_data_licencias");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin+"&tipo_plan="+tipo_plan+"&vendedor="+vendedor );
        });
