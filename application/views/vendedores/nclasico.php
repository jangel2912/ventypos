...
//
        ...
        $(".add").click(function(e){
            ...
            if(!flag_errors){
                ...
                var html = '<tr id="last"><td width="10"><input type="hidden" name="product_id[]" id="product_id" class="product_id"  value="'+$('#id_producto').val()+'"/><input type="hidden" name="codigo" class="codigo" id="codigo" value="'+$('#codigo').val()+'"></td><td><input type="hidden" name="product_name[]" class="product-service" value="'+$("#product-service").val()+'" id="product_name"/>'+$("#product-service").val()+'</td><td><textarea name="description[]" class="description">'+$("#descripcion").val()+'</textarea></td><td><input type="text" name="quantity[]" class="quantity" value="'+$("#cantidad").val()+'" id="cantidad"/></td><td><input style="text-align:right" value="'+$("#precio").val()+'" type="text" class="psi" name="psi[]"/></td><td><input type="text" name="discount[]" class="discount" id="discount" value="'+$("#descuento").val()+'"/></td><td><select name="impuesto[]" class="impuesto" id="'+$("#cantidad").val()+'_'+$("#product-service").val()+'"><?php foreach($data['impuestos'] as $key => $value){echo '<option value="'.$key.'">'.$value.'</option>';}?></select></td><td style="text-align:right" class="ptotal">'+ '' +'</td><td><a  class="button red delete" title="Eliminar" href="#"><div class="icon"><span class="ico-remove"></span></div></td></td></tr>';
