        ...
        <div class="block">
            ...
            <?php $permisos = $this->session->userdata('permisos');
                ...
                if(in_array("1004", $permisos) || $is_admin == 't'):?>
                    ...
                    <a href="<?php echo site_url("vendedores/nuevo")?>" data-tooltip="Nuevo Vendedor">                        
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="proveedoresTable">
                        <thead>
                            <tr>                                
                                ...
                                <th width="15%"><?php echo custom_lang('sima_nif', "Cédula");?></th>
                                <th width="20%"><?php echo custom_lang('sima_reason', "Email");?></th>
                                <th width="15%"><?php echo custom_lang('sima_contact', "Teléfono");?></th>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       oTable = $('#proveedoresTable').dataTable( {
                ...
                "sAjaxSource": "<?php echo site_url("vendedores/get_ajax_data");?>",
