...
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            ...
            <br>
            <form class="form-inline" action="<?php echo site_url("informes/habitos_consumo_mes_data2");?>" method="POST"  id="f_consumo_mes" >
                    ...
                    <template v-for="(item_1, i_1) in total_ventas_1">
                        ...
                        <template v-for="(item_3, vindex) in item_1.sales">
                            <tr v-if="item_1.fecha == item_3.fecha">
                                ...
                                <td>{{ item_3.total_devoluciones }}</td>
...
<script>
    var url_habitos = "<?php echo site_url("informes/habitos_consumo_mes_data_ajax");?>";
...
<script src="<?= base_url('/application/views/informes_vue/habitos_consumo_mes.js') ?>"></script>
    ...
    $(document).ready(function(){
        $("#ex").click(function(event){
            ...
            if($fecha_inicio.val() == '' && $fecha_final.val() == ''){
                ...
                var dir = "<?php echo site_url("informes/habitos_consumo_mes_excel");?>";
                $("#mensaje").html("");
                $("#mensaje").addClass('hidden');
                $("#f_consumo_mes").attr('action',dir);
                $("#f_consumo_mes").submit();
            }
        });
    })
