...
<div class="row-fluid">
    <?php echo form_open_multipart("mesas_secciones/editar/".$datos_mesa->id, array("id" => "f_validate")); ?>
    <div class="row-form">
     <div class="form-group">
       <div class="col-xs-12">
           ...
           <div class="col-sm-4">
               <input type="text"  value="<?php echo $datos_mesa->codigo_mesa; ?>" placeholder="" name="codigo" />
         ...
         <div class="col-sm-4">
             <input type="text"  value="<?php echo $datos_mesa->nombre_mesa ?>" placeholder="#1 o m1" name="nombre" />
            ...
            <div class="col-sm-4">
                <select name="seccion">
                    ...
                    <?php foreach ($data['secciones'] as $key => $value) { 
                        $selected = '';
                        if($value->id == $datos_mesa->id_seccion){
                            $selected = 'selected';
                        }
                        ?>
                    <option value="<?php echo $value->id; ?>" <?php echo $selected ?> ><?php echo $value->nombre_seccion. ' ( '.$value->nombre.' )'; ?></option> 
                    <?php } ?>
                </select>
