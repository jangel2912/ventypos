    ...
    <div class="col-md-8">
        ...
        <div class="form-container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <button id="proccess" @click="process" class="btn btn-success btn-block">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        methods: {
            ...
            process() {
                ...
                axios.post('<?php echo site_url('promocion/store'); ?>', this.data).then(res => {
                    ...
                    swal('¡Excelente!', 'La promoción ' + this.data.name + ' se actualizó con éxito.', 'success');
                }).catch(e => {
                    console.error(e);
                    swal({
                        title: "¡Oops!",
            ...
            loadPromotion() {
                axios.get('<?php echo site_url('promocion/get_promotion') . '/' . $this->uri->segment(3); ?>').then(res => {
                    this.data = res.data;
                });
            },
            loadWarehouses() {
