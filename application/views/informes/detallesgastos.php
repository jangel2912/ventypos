...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('detallesgastos', "Detalles de gastos");?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="head blue">
                ...
                <div class="data-fluid">
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="informesTable">
                        <thead>
                            <tr>
                                <th width="40%"><?php echo custom_lang('sima_date', "Fecha");?></th>
                                <th width="20%"><?php echo custom_lang('sima_description', "Descripcion");?></th>
                                <th width="20%"><?php echo custom_lang('valordelgasto', "Valor del gasto");?></th>
                            </tr>
                        </thead>
                        <tbody>
                         ...
                         <tfoot>
                            <tr>
                                ...
                                <th ><?php echo custom_lang('valordelgasto', "valor del gasto");?></th>
                            </tr>
                        </tfoot>
                    </table>
...
<script type="text/javascript">
    $(document).ready(function(){
       oTable = $('#informesTable').dataTable( {
                "bProcessing": true,
                /*"bServerSide": true,*/
                "sAjaxSource": "<?php echo site_url("informes/get_ajax_data_detallesgastos");?>",
        ...
        $("#ex").click(function(){
            ...
            var dir = "<?php echo site_url("informes/exdetallesgastos");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin;
            $(this).attr('href', dir);    
        ...
        $("#filtrar").click(function(){
            var fecha_inicio = $("#fecha_inicio").val();
            var fecha_fin = $("#fecha_fin").val();
            oTable.fnReloadAjax( "<?php echo site_url("informes/get_ajax_data_detallesgastos");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin );
        });
