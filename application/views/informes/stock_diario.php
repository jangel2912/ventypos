...
<div class="row-fluid">
    <div class="col-md-12">
        <div class="block">
            ...
            <?php endif; ?>
            <!--<a href="<?= site_url("informes/excel_stock_diario") ?>" id="ex" class="btn btn-success"><small class="ico-circle-arrow-down icon-white"></small><?php echo custom_lang('sima_export', "Exportar a Excel");?></a>-->
            <div class="col-md-6">   
            </div>
...
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            <div class="head blue">
                <h2><?php echo custom_lang('ventasxclientes', "Movimiento Material");?></h2>
            </div>
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="informesTable">
                        <thead>
                            <tr>
                                ...
                                <th width="20%"><?php echo custom_lang('sima_sales_taxes', "Almacén");?></th>
                                <th width="20%"><?php echo custom_lang('sima_sales_taxes', "Producto");?></th>
...
<script type="text/javascript">
    $(document).ready(function(){
       oTable = $('#informesTable').dataTable( {
                "bProcessing": true,
                "sAjaxSource": "<?php echo site_url("informes/get_ajax_data_stock_diario");?>",
        ...
        $("#ex").click(function(){
            ...
            var dir = "<?php echo site_url("informes/excel_stock_diario");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin+"&almacen="+almacen;
            $(this).attr('href', dir);    
        ...
        $("#filtrar").click(function(){
            ...
            if(dias_diferencia > 90){
                //alert("No es posible consultar los movimientos en un rango mayor a 3 meses");
                    ...
                    oTable.fnReloadAjax( "<?php echo site_url("informes/get_ajax_data_stock_diario");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin+"&almacen="+almacen );
            }
    ...
    //mixpanel.track("Informe_stock_diario");  
</script>