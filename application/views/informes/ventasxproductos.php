...
<div class="block title">
    ...
    <div class="head">
        ...
        <h2><?php echo custom_lang('ventasxproductos', "Ventas por Productos");?></h2>                                          
                    ...
                    <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="informesTable">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th width="40%"><?php echo custom_lang('sima_name', "Nombre del producto");?></th>

                                <th width="20%"><?php echo custom_lang('sima_amount', "Cantidad vendida");?></th>

                                <th width="20%"><?php echo custom_lang('sima_price', "Precio promedio");?></th>
                        ...
                        <tbody>
                         ...
                         <tfoot>
                            ...
                            <tr>
                                 ...
                                 <th ><?php echo custom_lang('sima_name', "Nombre del producto");?></th>

                                <th><?php echo custom_lang('sima_amount', "Cantidad vendida");?></th>

                                <th ><?php echo custom_lang('sima_price', "Precio promedio");?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       oTable = $('#informesTable').dataTable( {
                ...
                "sAjaxSource": "<?php echo site_url("informes/get_ajax_data_ventasxproductos");?>",
        ...
        $("#ex").click(function(){
            ...
            var dir = "<?php echo site_url("informes/exventasxproductos");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin;
        ...
        $("#filtrar").click(function(){
            ...
            oTable.fnReloadAjax( "<?php echo site_url("informes/get_ajax_data_ventasxproductos");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin );
