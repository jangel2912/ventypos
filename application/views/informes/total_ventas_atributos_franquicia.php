    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('ventasxclientes', "Total de de ventas por atributos franquicias");?></h2>
            </div>
        </div>
     </div>
</div>
<div class="row-fluid">
    <div class="span12 well">
        <form id="formulario" action="<?php echo site_url("informes/total_ventas_atributos_data_franquicia") ?>" method="POST">
            <div class="row-fluid">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#consultar').on('click', function(e){
            $.post(
                "<?= site_url('informes/total_ventas_atributos_ajax_data_franquicia') ?>",
    ...
    mixpanel.track("Informe_Existencias_inventario_atributos");  
</script> 