...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('sima_granted_discounts', "Descuentos otorgados");?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <div class="span12">
                        ...
                        <thead>
                            <tr>
                               <th width="10%"><?php echo custom_lang('sima_number', "N&uacute;mero");?></th>
                                ...
                                <th width="20%"><?php echo custom_lang('sima_product', "Producto");?></th>
                                <th width="10%"><?php echo custom_lang('sima_price', "Precio");?></th>
                                <th width="10%"><?php echo custom_lang('sima_amount', "Cantidad");?></th>
                                <th width="15%"><?php echo custom_lang('sima_discount_unit', "Descuento por unidad");?></th>
                                <th width="15%"><?php echo custom_lang('sima_discount_total', "Descuento total");?></th>
                            </tr>
                        </thead>
                        <tbody>
                         ...
                         <tfoot>
                            <tr>
                                ...
                                <th ><?php echo custom_lang('sima_product', "Producto");?></th>
                                <th ><?php echo custom_lang('sima_price', "Precio");?></th>
                                <th ><?php echo custom_lang('sima_amount', "Cantidad");?></th>
                                <th ><?php echo custom_lang('sima_discount_unit', "Descuento por unidad");?></th>
                                <th ><?php echo custom_lang('sima_discount_total', "Descuento total");?></th>
                            </tr>
                        </tfoot>
                    </table>
...
<script type="text/javascript">
    $(document).ready(function(){
       oTable = $('#informesTable').dataTable( {
                "bProcessing": true,
                /*"bServerSide": true,*/
                "sAjaxSource": "<?php echo site_url("informes/get_ajax_data_descuentosotorgados");?>",
        ...
        $("#ex").click(function(){
            ...
            var dir = "<?php echo site_url("informes/exdescuentosotorgados");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin;
            $(this).attr('href', dir);    
        ...
        $("#filtrar").click(function(){
            var fecha_inicio = $("#fecha_inicio").val();
            var fecha_fin = $("#fecha_fin").val();
            oTable.fnReloadAjax( "<?php echo site_url("informes/get_ajax_data_descuentosotorgados");?>?fecha_inicio="+ fecha_inicio+"&fecha_fin="+fecha_fin );
        });
