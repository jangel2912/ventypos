...
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                <h2><?php echo custom_lang('ventasxclientes', "Informe de Transacciones");?></h2>
            </div>

            <form class="form-inline" action="<?php echo site_url("informes/transacionesinforme_data");?>" method="POST" target="_blank" id="validate" >
