...
<div class="block title">
    <div class="head">
        <h2><?php echo custom_lang('cuadrecaja', "Exportaci&oacute;n a Siigo");?></h2>                                          
    </div>
</div>
<div class="row-fluid">
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('ventasxclientes', "Exportaci&oacute;n a Siigo");?></h2>
            </div>
                <form action="<?php echo site_url("informes/export_siigo_data");?>" method="POST">
                <table>
                    <tr>
                        ...
                        <td width="30%">Fecha Final : <input type="text" name="datefinal" value="<?php echo $this->input->post('datefinal');?>" class="datepicker"/>
                        </td>
