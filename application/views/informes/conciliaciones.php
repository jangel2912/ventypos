...
<div class="row-fluid">
    <div class="span12">
        <div class="block">         
            <div class="head blue">
                <h2><?php echo custom_lang('conciliaciones', "Informe de Conciliaciones");?></h2>
            </div>
                ...
                <table class="table aTable" cellpadding="0" cellspacing="0" width="100%" id="informesTable">
                    <thead>
                        <tr>
                            ...
                            <th width="10%"><?php echo custom_lang('sima_sales', "Transaccion");?></th>
                            <th width="10%"><?php echo custom_lang('sima_sales_taxes', "Gastos bancarios");?></th>
                            <th width="10%"><?php echo custom_lang('sima_sales_taxes', "Impuestos bancarios");?></th>
                            <th width="10%"><?php echo custom_lang('sima_sales_taxes', "Entradas bancarias");?></th>
                            <th width="10%"><?php echo custom_lang('sima_sales_taxes', "Saldo final");?></th>
                            <th width="10%"><?php echo custom_lang('sima_sales_taxes', "Fecha Corte");?></th>
...
<script type="text/javascript">
    $(document).ready(function(){
        oTable = $('#informesTable').dataTable( {
            "bProcessing": true,
            "sAjaxSource": "<?php echo site_url('informes/get_ajax_conciliaciones');?>",
        ...
        $("#ex").click(function(){
            ...
            var url = '<?php echo site_url("informes/ex_conciliaciones");?>'+'?fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin+'&banco='+banco;
            $(this).attr('href', url);    
            
        });
        
        $("#filtrar").click(function(){
         filtrar_conciliaciones();   
        });
     
        function filtrar_conciliaciones(){
            var fecha_inicio = $("#fecha_inicio").val();
            var fecha_fin = $("#fecha_fin").val();
            var banco = $("#bancos").val();
            var url = '<?php echo site_url("informes/get_ajax_conciliaciones");?>'+'?fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin+'&banco='+banco;
