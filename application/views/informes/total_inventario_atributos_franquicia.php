...
<div class="row-fluid">
    <div class="span12 well">
        <form id="formulario" action="<?php echo site_url("informes/total_inventario_atributos_data_franquicia") ?>" method="POST">
            <div class="row-fluid">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#consultar').on('click', function(e){
            $.post(
                "<?= site_url('informes/total_inventario_atributos_ajax_data_franquicia') ?>",
