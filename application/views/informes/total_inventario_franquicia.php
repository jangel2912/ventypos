    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="head blue">
                ...
                <h2><?php echo custom_lang('ventasxclientes', "Total de inventario Franquicias");?></h2>
            </div>
        </div>
     </div>
</div>
<div class="row-fluid">
    <div class="span12 well">
        <form id="formulario" action="<?php echo site_url("informes/total_inventario_data_franquicia") ?>" method="POST">
            <div class="row-fluid">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#consultar').on('click', function(e){
            $.post(
                "<?= site_url('informes/total_inventario_ajax_data_franquicia') ?>",
