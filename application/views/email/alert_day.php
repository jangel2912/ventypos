              ...
              <td class="bodycopy">
                ...
                <p>
                    <?php if($day == 1): ?>
                        ...
                        regálanos una llamada a  los teléfonos  <b>(319) 4751398 - (318) 8018675 </b><br><br>
                        Respóndeme este correo para que agendate en mi calendario. 
                        <a href="https://vendty.reservio.com/" target="_blank" style=" text-decoration: none;" class="">aquí</a> para despejar tus dudas y ayudarte a usar Vendty.
                    <?php endif; ?>

                    <?php if($day == 6): ?>
                        Hoy se acaban los días de pruebas en Vendty, nuestro sistema reporta que no has ingresado a probarlo, sabemos lo agitados que suelen ser estos días, por eso quiero invitarte a que lo pruebes por <b>7 días más</b>, además yo personalmente te ayudare a configurar el sistema para que lo puedas usar en tu empresa.<br><br>
                        Si quieres extender tu periodo de prueba respóndeme este correo, regálame una llamada a los teléfonos <b>(319) 4751398 - (318) 8018675 </b> o  agendate en mi calendario <a href="https://vendty.reservio.com/" target="_blank" style=" text-decoration: none;" class="">aquí</a> para despejar tus dudas y ayudarte a usar Vendty.
                    <?php endif; ?>

                    <?php if($day == 14): ?>
                        Se te agotará el tiempo muy pronto.<br><br>
                        Haz crecer tu negocio con nuestro Software, si tienes alguna duda regálanos una llamada a  los teléfonos  <b>(319) 4751398 - (318) 8018675 </b><br><br>
                        O haz click <a href="https://vendty.reservio.com/" target="_blank" style=" text-decoration: none;" class="">aquí</a> para despejar tus dudas y ayudarte a usar Vendty.
                    <?php endif; ?>
                </p>
              </td>
            </tr>
                ...
                <table class="buttonwrapper" border="0" cellspacing="10" cellpadding="0" align="center">
                  <tr>
                    <td class="button" height="45" style="background: #45af6d;">
                      <a target="_blank" href="https://pos.vendty.com">¡Empieza a vender!</a>
                    </td>
                    <td class="button" height="45" style="background: #45af6d;">
                      <a target="_blank" href="http://vendty.com/reserva#agenda">Agendar demostración</a>
                    </td>
                  </tr>
                </table>
              </td>
