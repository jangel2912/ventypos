      ...
      <tr>
        <td class="innerpadding2" style="background:#F3F3F3;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
            ...
            <tr>
              <td class="bodycopy">
                <p>Vendty - POS y Tienda Virtual - Resumen de ventas del dia: <?php echo $fecha; ?>
                    <div align="center"><strong>Almacen: <?= $almacen; ?> </strong> </div>
                </p>
                
                <table align="left" border="0" cellpadding="10" cellspacing="5" width="100%" class="templateColumnContainer">
                    <tr>
