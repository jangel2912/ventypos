          ...
          <table width="200" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0;">
                <img class="fix" src="<?= base_url().'uploads/'.$logo; ?>" width="100%" border="0" alt="" style="margin-left:2rem;"/>
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
            ...
            <tr>
              <td class="bodycopy">
                <p>
                    ...
                    Has sido asociado/a al plan de puntos <strong><?= $plan_name; ?></strong>
                    <br><br>
                    Por cada $<?= $points_value; ?> en compras, acumula <?= $points; ?> punto/s.
                    <br><br>
                    Recuerda que la fecha de caducidad para redimir tus puntos es de <?= $date_of_expiry; ?> mes/es.
                    <br><br>
                    Pasado este limite, tus puntos venceran.
                    <br><br>    
                </p>
              </td>
            </tr>
                        ...
                        <tbody>
                            <tr>
                              <td align="center" style="padding:10px;font-family:sans-serif;font-size:12px;color:#fff;line-height:20px">
                                  Correo enviado desde software <a style="color:#fff;"  href="http://vendty.com/">VENDTY</a>
