...
<head>
  ...
  <style type="text/css">
    ...
    .h1, .h2, .bodycopy {color: #153643; font-family: sans-serif; text-align: justify;}
    ...
    <tr>
      <td> 
        <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td class="header">
              <table width="400" align="left" border="0" cellpadding="0" cellspacing="0">  
                <tr>
                  <td height="70" style="padding: 0 20px 20px 0;">
                    <img width="200" class="fix" src="https://vendty.com/wp-content/uploads/2019/05/logo.png" width="100%" border="0" alt="" style="margin-left:2rem;"/>
                  </td>
                  <td height="70" style="padding: 0 20px 20px 0;">
                    <img width="200" class="fix" src="https://admintienda.vendty.com/img/logo_bluecaribu.png" width="100%" border="0" alt="" style="margin-left:2rem;"/>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="innerpadding2" style="background:#F3F3F3;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
                ...
                <tr>
                  <td class="bodycopy">
                    <span class="text-black"> ¡Hola <strong><?= $user; ?></strong>!</span><br>
                    <p>
                      Queremos agradecer tu interés en Vendty y tu disposición para poder conocer más de nuestra tienda virtual. Desde este momento inicia tu prueba gratuita de 7 días, en la que podrás configurar tu tienda y comenzar a vender en línea.<br><br>
                      Para poder entrar al sistema requerirás la siguiente información:<br><br>  
                      <strong>Dirección de mi tienda: </strong><a target="_blank" href="<?= $store; ?>"><?= $store; ?></a><br>
                      <strong>URL de acceso: </strong><a target="_blank" href="https://admintienda.vendty.com/">https://admintienda.vendty.com/</a><br>
                      <strong>Nombre de usuario: </strong><?= $email; ?><br>
                      <strong>Contraseña de acceso: </strong><?= $password; ?>
                      <p>Si tienes inquietudes o preguntas no dudes en contactarnos, puedes hacerlo a través del siguiente número de teléfono +573188018675</p>
                      <p>Tenemos plena seguridad de podrás sacarle el máximo provecho a esta prueba gratuita y descubrirás como incrementar tus ventas con Vendty ¡Gracias por elegirnos!</p>
                      <p>Equipo Vendty y BlueCaribu.</p>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 20px 0 0 0;">
                    <table class="buttonwrapper" border="0" cellspacing="10" cellpadding="0" align="center">
                      <tr>
                        <td class="button" height="45" style="background: #45af6d;">
                          <a target="_blank" href="https://admintienda.vendty.com">Configurar Tienda</a>
                        </td>
                        <td class="button" height="45" style="background: #45af6d;">
                          <a href="http://vendty.com/reserva#agenda">Agendar capacitación</a>
                        </td>
                      </tr>
                    </table>
                  </td>
