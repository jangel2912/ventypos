            ...
            <tr>
              <td class="bodycopy">
                <p>
                    ...
                    Has realizado una compra por un valor de <b>$<?= number_format($sale_value); ?></b> y has acumulado <b><?= $accumulated_points; ?> PUNTO/S</b>.
                    <br><br>
                     Total de puntos disponibles: <b><?= $total_points; ?> PUNTO/S </b>  
                    <br><br>
