        ...
        <td class="innerpadding2" style="background:#F3F3F3;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
            ...
            <tr>
              <td class="bodycopy">
                <p> 
                    Hemos notado que has terminado con exito tus primeros pasos. <br>
                    <br>    
                    A continuación te dejamos algunos enlaces de utilidad:
                    <br><br>
                    
                    <a class="link" target="_blank" href="https://pos.vendty.com/index.php/ventas/nuevo">¡Empieza a vender!</a> •
                    <a class="link" target="_blank" href="https://pos.vendty.com/index.php/productos">Ir a mi Inventario</a> •
                    <a class="link" target="_blank" href="https://pos.vendty.com/index.php/informes">Ver mis informes</a>
                    <br>
                    <!--<table class="buttonwrapper" border="0" cellspacing="10" cellpadding="0" align="center">
                        <tr>
                            <td height="45" style="background: #45af6d;">
                    ...
                    <br>
                    Recuerda que si tienes alguna duda y necesitas una demostración la puedes agendar <a target="_blank" href="https://vendty.com/reserva" class="link">AQUÍ</a>.<br><br>
                    <b>Atentamente: Eloy Lopez</b><br><br>
