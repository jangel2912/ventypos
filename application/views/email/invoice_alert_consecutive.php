              ...
              <td class="bodycopy">
                ...
                <table border="1" cellpadding="0" cellspacing="0" height="100%" width="100%">
                    <tr>
                        ...
                        <td align="center">N° Factura Actual</td>
                        <td align="center">N° Finalización</td>
                    </tr>

                    <?php foreach($stores as $store): ?>
                        <tr>
                            <td><?= $store['almacen'] ?></td>
                            <td align="center" valign="top" style="color:#ff0000"><?= $store['consecutivo'] ?></td>
                            <td style="color:#ff0000" align="center" valign="top"><?= $store['numero_fin'] ?></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
                    <p>Le recomendamos verificar la configuración del sistema y modificar los limites de alertas para consecutivos de factura.</p>
                     <br>
