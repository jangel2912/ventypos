          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
              ...
              <tr>
                <td class="bodycopy">
                  ...
                  <p>
                    Queremos agradecer tu interés en Vendty y tu disposición para poder conocer más de nuestro sistema POS. Desde este momento inicia tu prueba gratuita de 7 días, en la que podrás acceder a nuestra plataforma y conocer por qué somos la mejor opción para administrar tu negocio. <br> <br>
                    Para poder entrar al sistema requerirás la siguiente información: <br> <br>  

                      <strong>URL de acceso:</strong> <a target="_blank" href="https://pos.vendty.com/">pos.vendty.com</a><br>
                      <strong>Nombre de usuario:</strong> <strong> <?= $email; ?> </strong> <br>
                      <strong>Contraseña de acceso:</strong> <strong> <?= $password; ?> </strong>
