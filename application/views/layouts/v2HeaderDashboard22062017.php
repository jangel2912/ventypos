...
<html class="no-js css-menubar">
	...
	<iframe id="frameOffline" style="display: none;"></iframe>
        ...
        <!-- MODAL FINALIZACION PRUEBA 7 DIAS -->
            ...
            <div class="modal fade in" id="modalFinPruebaCont" aria-hidden="true" aria-labelledby="examplePositionCenter" role="dialog" tabindex="-1" style="padding-right: 17px;" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="padding:0px;">
                            ...
                            <div style="position:absolute; right: 0px; text-align: center; width: 360px">
                                ...
                                <div style="font-size:14px;margin-top:20px; width:250px; margin-left:80px;">Esperamos que haya sido de su agrado la prueba. Si gusta seguir disfutando de VendTy, debe <strong>actualizar</strong> a un plan de pago haciendo click <strong> <a href="https://checkout.payulatam.com/ppp-web-gateway-payu//pr?dlink=0f8266M83278R6d" target="_blank">aquí</a>.</strong></div>
...
<?php } ?>
        ...
        <div class="page animsition">
            ...
            <div class="toast-warning">    
                ...
                <span id="msgAlertaDemo"><strong> ¡Importante! </strong> Queda <strong><?php echo $dias; ?></strong> días de prueba. &nbsp;&nbsp; Adquiera  <strong>2x1</strong> (dos años por el precio de uno) si compras antes de finalizar el periodo de prueba, llamanos al <strong>319-475-13-98</strong> 
            ...
            <?php if($estado == 1){ ?>
                ...
                <div  id="div_mensaje_renovacion" style="display: none;">    

                    <span id="logoAlertaDemo"><i class="icon wb-warning" aria-hidden="true"></i></span>    

                    <span id="msgAlertaDemo"><strong> ¡Importante! </strong> Tu licencia expirara en: <strong><?php echo $data['dias_licencia']; ?></strong> días. Para renovar tu licencia  <a id="a_modal_expiracion">clic aquí</a>  
