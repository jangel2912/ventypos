...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/css/app/restaurantDesign.css?626546949">
    <!--CSS Restaurant Style Design MESERO 1 -->
    <!--CSS VENTAS MI ORDEN -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>public/css/app/restaurantMiOrden.css?626546949">
...
<div class="v2h">
    ...
    <?php include("menuescritorio.php"); ?>
</div>
<!-- Page -->
<div class="page animsition" style="height: 100%">
