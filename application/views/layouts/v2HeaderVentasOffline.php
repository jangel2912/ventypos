...
<html class="no-js css-menubar" >
    ...
    <?php get_css("<link rel='stylesheet' href='$1'>"); ?>
        ...
        <style> 
            ...
            .site-menubar-unfold #btnUi1{

                display:initial !important;

            }

            .site-menubar-fold #btnUi1{

                display:none !important;

            }            

            .site-menubar-unfold #btnUi2{

                display:none !important;

            }

            .site-menubar-fold #btnUi2{
        ...
        <div class="v2h">
            ...
            <div id="logoCont">
                ...
                <a href="javascript:void(0)">
                    ...
                    <img class="navbar-brand-logo2" src="<?php echo base_url(); ?>public/v2/img/logo_solo.png" title="Vendtys">
                        ...
                        <div>                                                    
                            ...
                            <ul class="site-menu">
                                ...
                                <li class="site-menu-item">
                                    ...
                                    <a href="<?php echo site_url() ?>/ventasOffline/nuevo/">
                                ...
                                <li class="site-menu-item">
                                    ...
                                    <a href="<?php echo site_url() ?>/ventasOffline/ventas/">

                                        <i class="site-menu-icon wb-print" aria-hidden="true"></i>

                                        <span class="site-menu-title"><h5>Facturas</h5></span>
                                ...
                                <li id="btnSincCont" class="site-menu-item" style="display:none">

                                    <a href="javascript:iniciarConexion()">                                        

                                      <h5 id="btnSinc"><strong>Sincronizar</strong></h5>
