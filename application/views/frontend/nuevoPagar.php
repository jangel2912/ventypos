    <style type="text/css">
        ...
        .price-table:after {
            ...
            bottom: -16px;
            left: 0;
            background: -webkit-linear-gradient(-135deg, lightgray 50%, transparent 50%) 0 50%, -webkit-linear-gradient(-45deg, lightgray 50%, transparent 50%) 0 50%, transparent;
        ...
        .head:before {
            ...
            width: 13px;
            height: 13px;
            background-color: #fff; /* Cortes en los boletos */
            position: absolute;
            right: -22px;
            border-radius: 50%;
            z-index: 2000;
        ...
        * {
        ...
        .price-table {
            ...
            background-color: lightgray; /** Color del ticket */
            text-align: center;
            ...
            <div class="flip-me">
                <div class="front">
                    <div class="price-table">
                        ...
                        <button class="submit">Seleccionar</button>
                    </div>
                </div>
                <div class="back add-films">
                    <div class="price-table ">
                        ...
                        <section class="price">
                            <h2>
                                <span class="year">Only</span><span class="dollar">$</span>99<span
                                    class="year">more</span>
                            </h2>
                        </section>
