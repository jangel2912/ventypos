    ...
    <center style="width: 100%; background: #f2f2f2;">
        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" width="550" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 15px 5px 5px 5px; text-align: left">
                    <a href="http://vendty.com"><img src="http://vendty.mx/wp-content/uploads/2016/11/logo_white_bg_zoho.jpg" width="160" height="auto" alt="vendty" border="0"></a>
                </td>
            </tr>
            <tr>
      ...
      <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="550" style="margin: auto; " class="email-container">
            ...
            <tr><td>&nbsp;</td>
                ...
                <td style="padding: 25px 25px 10px 25px; text-align: center; font-family: sans-serif; font-size: 210%; mso-height-rule: exactly; line-height: 28px; color: #555555;font-weight: lighter;">
                    ¡Hola <?php echo $nombre ?>!
                </td>
            </tr>
            <tr>
        
                <td style="padding: 15px 25px 30px 25px; text-align: left; font-family: sans-serif; font-size: 120%; mso-height-rule: exactly; line-height: 20px; color: #555555;font-weight: lighter;">
                    Nuestro sistema reporta que no has empezado a usar vendty, quiero contarte que  hay un equipo de expertos dispuesto a ayudarte y asesorarte
                    regálame una llamada a  los teléfonos  <b>(319) 4751398 - (318) 8018675 </b><br><br>
                    Respóndeme este correo para que agendate en mi calendario <a href="https://vendty.reservio.com/" target="_blank" style=" text-decoration: none;" class="">aquí</a> para despejar tus dudas y ayudarte a usar Vendty.
                </td>
            </tr>
             <tr>
        
                <td style="padding: 0px 0px 25px 0px; text-align: center; font-family: sans-serif; font-size: 12px; mso-height-rule: exactly; line-height: 0px; color: #555555;font-weight: lighter;">
                <table width="100%" border="0" >
  <tbody>
    <tr>
      <td><a href="https://www.youtube.com/embed/Sysd6egxMto?rel=0&autoplay=1" target="_blank"><img src="http://www.vendty.com/blog/wp-content/uploads/2017/04/bottonstart.jpg" width="100%" height="auto" alt="Prueba gratis por 7 días" border="0" align="center" style="width: 100%; max-width: 500px;"></a></td>
            ...
            <tr>
                <!-- Background image -->
                <td background="http://vendty.com/wp-content/uploads/support-C.png" bgcolor="#EB6D12" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    <!--[if gte mso 9]>
                    ...
                    <div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="max-width:550px; margin: auto;">
                            <tr>
                                <td valign="middle" style="text-align: center; padding: 40px 20px; font-family: sans-serif; font-size: 110%; mso-height-rule: exactly; line-height: 25px; color: #ffffff;font-weight:lighter">
                                    <span style="font-size: 168%;font-weight:bold">Solicita una demostración guiada</span><br>
                                    Descubre como  puedes controlar y hacer  crecer tu negocio.
                                    <br><br>
                                    <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" align="center">
                                        <tr>
                                            <td style="border-radius: 3px; text-align: center;">
                                                <a href="https://vendty.reservio.com/" target="_blank" style=" border: 1px solid #ffffff; font-family: sans-serif; font-size: 100%; line-height: 1.1; text-align: center; padding:15px;text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-b">
                                                    <span style="color:#ffffff">&nbsp;Agenda una demostración →&nbsp;</span>
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" width="450" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:16px; text-align: center; color: #888888;">
                    ...
                    Este e-mail fue enviado a usted por <a href="mailto:asesor@vendty.com">asesor@vendty.com</a>. Si usted ya no desea recibir mas mensajes de correo electrónico, puede <unsubscribe style="color:#0981E2; text-decoration:underline;">darse de baja</unsubscribe>
                </td>
            </tr>
        </table>
        <!-- Footer -->
