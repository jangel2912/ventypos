...
<body bgcolor="#fff" width="100%" style="margin: 0;">
      ...
      <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="550" style="margin: auto; " class="email-container">
            ...
            <tr><td>&nbsp;</td>
                ...
                <td style="padding: 25px 25px 10px 25px; text-align: center; font-family: sans-serif; font-size: 210%; mso-height-rule: exactly; line-height: 28px; color: #555555;font-weight: lighter;">
                    Se te agotará el tiempo muy pronto 
                </td>
            </tr>
            <tr>
        
                <td style="padding: 15px 25px 30px 25px; text-align: center; font-family: sans-serif; font-size: 120%; mso-height-rule: exactly; line-height: 20px; color: #555555;font-weight: lighter;">
                    Haz crecer tu negocio con nuestro Software. 
                </td>
            </tr>
             <tr>
  ...
  <tbody>
    <tr>
      <td><a href="https://www.youtube.com/embed/Sysd6egxMto?rel=0&autoplay=1" target="_blank"><img src="http://vendty.com/wp-content/uploads/Imgcorreo15.jpg" width="100%" height="auto" alt="Prueba gratis por 7 días" border="0" align="center" style="width: 100%; max-width: 500px;"></a></td>
