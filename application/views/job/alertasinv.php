...
<body bgcolor="#fff" width="100%" style="margin: 0;" style="width: 100%; background: #f2f2f2;">
  ...
  <tbody>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="max-width:550px; margin: auto;">
                            <tr>
                                <td valign="middle" style="text-align: left; padding: 20px 20px 0px 20px; font-family: sans-serif; font-size: 100%; mso-height-rule: exactly; line-height: 25px; color: #444;font-weight:lighter">
                                    <strong style="font-size:20px;">Hola <?php echo $nombre ?>,</strong>
                                    <br>Estos productos estan proximos a agotarse.
                                    &nbsp;
                                   
                                           <div style="margin-top:20px;"><table width="400" border="0" style="margin-top:30px; padding:20px;">
    <tbody>
        <tr>
            <td style=" color: #5a5a5a; padding:3px 0px 3px 10px; border:1px solid #fff; width:300px;"><strong>Producto</strong></td>
            <td style=" color:#5A5A5A; padding:3px 0px 3px 10px; border:1px solid #fff; width:100px;"><strong>Almacen</strong></td>
            <td style=" color:#5A5A5A; padding:3px 0px 3px 10px; border:1px solid #fff; width:70px;"><strong>Inventario</strong></td>
        </tr>
        <?php
        $i = 1;
        foreach($productos as $p)
        {
            ...
            ?>
            <tr>
                <td style="background-color:#999999; color: #FFFFFF; padding:3px 0px 3px 10px; border:1px solid #fff;"><?php echo $p->nombre ?></td>
                <td style="background-color:#f1f1f1; color:#5A5A5A; padding:3px 15px 3px 10px; border:1px solid #fff;"><?php echo $p->almacen ?></td>
                <td style="background-color:#f1f1f1; color: #5A5A5A; padding:3px 0px 3px 10px; border:1px solid #fff;text-align:right; padding-right: 10px; "><?php echo $p->unidades ?></td>
            </tr>
            <?php
            $i++;
        }
    ...
    <center>
        <a href="<?php echo $url ?>" class="btn-primary" style="text-decoration: none; border-radius: 10px; width: 250px" >
            
            <h2 style="width: 250px; border-radius: 25px; text-align: center;text-decoration: none;color: #fff;background-color: #88BF6C !important;border-color: transparent !important;">
                Descargar informe completo<br>
                <img src="http://vendty.com/invoice/public/img/Download.png" width="25px" style="padding-top:2px; padding-right: 2px;">
