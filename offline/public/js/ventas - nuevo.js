...
$(".precio-prod").live('click', function(){
    ...
    precioContent = "<form id='Calc'><table ><tr><td><input type='text' value='' name='Input' class='Input'/><input type='hidden' value='' name='Input1' class='Input1'/></td></tr>";
    precioContent += "<tr><td><input type='button' style='background-color: #0078e7; color: #fff;' class=' one' value='  1  ' name='one'/>&nbsp;<input type='button' style='background-color: #0078e7; color: #fff;' class=' two' value='  2  ' name='two'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' three' type='button' value='  3  ' name='three'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' sum' type='button' value=' + ' name='sum'/><br/>";
    precioContent += "<input type='button' style='background-color: #0078e7; color: #fff;' class=' four' value='  4  ' name='four'/>&nbsp;<input type='button' style='background-color: #0078e7; color: #fff;' class=' five' value='  5  ' name='five'/>&nbsp;<input type='button' style='background-color: #0078e7; color: #fff;' class=' six' value='  6  ' name='six'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' rest' type='button' value='  - ' name='rest'/><br/>";
    precioContent += "<input type='button' style='background-color: #0078e7; color: #fff;' class=' seven' value='  7  ' name='seven'/>&nbsp;<input type='button' value='  8  ' style='background-color: #0078e7; color: #fff;' class=' eith' name='eith'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' nine' type='button' value='  9  ' name='nine'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' mult' type='button' value='  * ' name='mult'/><br/>";
    precioContent += "<input type='button' style='background-color: #0078e7; color: #fff;' class=' clear' value='  C  ' name='clear'/>&nbsp;<input class=' cero' style='background-color: #0078e7; color: #fff;' type='button' value='  0  ' name='cero'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' doIt' type='button' value='  =  ' name='doIt'/>&nbsp;<input style='background-color: #0078e7; color: #fff;' class=' divi' type='button' value='  / ' name='divi'/>&nbsp;&nbsp;<input class='btn porcen' type='button' value='  + ' name='porcen'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' id='btn-accept-precio' class='btn btn-primary'><span class='icon-ok icon-white'></span></button>";
    precioContent += "</td></tr></table></form>";
    precioField.popover({
        placement: 'bottom'
        , title: 'Precio'
        , html: true
...
$(".one, .two, .three, .sum, .four, .five, .six, .seven, .eith, .nine, .cero, .rest, .mult, .divi, .doIt, .clear, .porcen").live('click', function(){
    ...
    switch (data.split(' ')[1]){
        ...
        case 'doIt':
		     ...
		     if($('.Input1').val() == 'porcentaje'){
				 
				  var str = $('.Input').val();
				  var res = str.replace("%", "*");
				var final = parseInt(eval(res));
				var final1 = parseInt(final/100);
		        $('.Input').val(final1);
...
$(document).ready(function(){
        ...
        $("#search").keyup(function(e){
            ...
            if(tipo_busqueda == 'buscalo'){
                ...
                if(cliente_selecionado.id_cliente){
                   var cliente = cliente_selecionado.id_cliente; 
                   var grupo = cliente_selecionado.grupo_clientes_id;
                }else{
                   var cliente = '';
                   var grupo = 0;
                }
        ...
        function formatRows(row){
            ...
            html += "<p><span class='stock'>Stock: "+row.stock_minimo+"</span>&nbsp;<input type='hidden' value='"+row.precio_compra+"' class='precio-compra-real'/><span class='precio-minimo'>C&oacute;digo de barras: "+codibarra+"</span></p><input type='hidden' class='id_producto' value='"+row.id+"'/><input type='hidden' class='codigo' value='"+row.codigo+"'><input type='hidden' class='impuesto' value='"+row.impuesto+"'></td></tr>";
            return html;
        }
        ...
        $("#dialog-forma-pago-form").dialog({
			...
			buttons: {
				"Aceptar": function() {
                                      ...
                                      if(cliente_selecionado.id_cliente){
                                         console.log('existe');
                                        cliente = {'nombre' : cliente_selecionado.nombre_comercial, 'identificacion' : cliente_selecionado.id_cliente, "correo" : cliente_selecionado.email, 'telefono' : cliente_selecionado.telefono};
                                       }
                                      else{
                                        console.log('no existe');
                                        cliente = {'nombre' : '', 'identificacion' : '', "correo" : '', 'telefono' : ''};
                                      }
                                        ...
                                        $(".title-detalle").each(function(x){
                                            var descuento = 0;
                                            if($(".precio-prod-real-no-cambio").eq(x).val() > $(".precio-prod-real").eq(x).val()){
...
function renderFactura(){
    ...
    if(matching == -1){
        ...
        rowHtml += "<td><span class='label label-success cantidad'>"+1+"</span></td>";
        rowHtml += "<td><span class='label label-success precio-prod'>"+formatDollar(sProduct.precio_venta)+"</span><input type='hidden' class='precio-prod-real' value='"+sProduct.precio_venta+"'/><input type='hidden' class='precio-prod-real-no-cambio' value='"+sProduct.precio_venta+"'/></td>";
        rowHtml += "<td><span class='precio-calc'>"+formatDollar(sProduct.precio_venta)+"</span><input type='hidden' value='precio-calc-real' value='"+sProduct.precio_venta+"'/></td>";
        rowHtml += "<td><td><a class='button red delete' href='#'><div class='icon'><span class='ico-remove'></span></div></a></td></td>";
        rowHtml += "</tr>";
