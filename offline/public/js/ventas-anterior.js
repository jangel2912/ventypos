...
$(".precio-prod").live('click', function(){
    ...
    precioContent = "<form id='Calc'><table width='100%'><tr><td><input type='text' value='0' name='Input' class='Input'/></td></tr>";
    precioContent += "<tr><td><input type='button' class='btn one' value='  1  ' name='one'/>&nbsp;<input type='button' class='btn two' value='  2  ' name='two'/>&nbsp;<input class='btn three' type='button' value='  3  ' name='three'/>&nbsp;<input class='btn sum' type='button' value=' + ' name='sum'/><br/>";
    precioContent += "<input type='button' class='btn four' value='  4  ' name='four'/>&nbsp;<input type='button' class='btn five' value='  5  ' name='five'/>&nbsp;<input type='button' class='btn six' value='  6  ' name='six'/>&nbsp;<input class='btn rest' type='button' value='  - ' name='rest'/><br/>";
    precioContent += "<input type='button' class='btn seven' value='  7  ' name='seven'/>&nbsp;<input type='button' value='  8  ' class='btn eith' name='eith'/>&nbsp;<input class='btn nine' type='button' value='  9  ' name='nine'/>&nbsp;<input class='btn mult' type='button' value='  * ' name='mult'/><br/>";
    precioContent += "<input type='button' class='btn clear' value='  C  ' name='clear'/>&nbsp;<input class='btn cero' type='button' value='  0  ' name='cero'/>&nbsp;<input class='btn doIt' type='button' value='  =  ' name='doIt'/>&nbsp;<input class='btn divi' type='button' value='  / ' name='divi'/>&nbsp;<button type='button' id='btn-accept-precio' class='btn btn-primary'><span class='icon-ok icon-white'></span></button>";
...
$(document).ready(function(){
        ...
        function formatRows(row){
            ...
            html += "<p><span class='stock'>Stock: "+row.stock_minimo+"</span>&nbsp;<input type='hidden' value='"+row.precio_compra+"' class='precio-compra-real'/><span class='precio-minimo'>Codigo de barra: "+formatDollar(row.precio_compra)+"</span></p><input type='hidden' class='id_producto' value='"+row.id+"'/><input type='hidden' class='codigo' value='"+row.codigo+"'><input type='hidden' class='impuesto' value='"+row.impuesto+"'></td></tr>";
            return html;
        }
