...
$(".precio-prod").live('click', function(){
    ...
    precioContent = "<form id='Calc'><table  width='100%'><tr colspan='4'><td><input type='text' value=' ' name='Input' class='Input'/><input type='text' value='"+precioField.text()+" * ' name='Input2' class='Input2'/><input type='text' name='Input3' class='Input3'/><input type='text' name='Input4' class='Input4'/></td></tr></table><hr>";
	
    precioContent += "<table  width='100%' ><tr>";
    precioContent += "<td>";	
	...
	precioContent += "&nbsp;&nbsp;<input class='btn divi' type='button'  value='    %   ' name='divi'/>";
    precioContent += "</td>";	
    precioContent += "</tr>";		
...
$(".one, .two, .three, .sum, .four, .five, .six, .seven, .eith, .nine, .cero, .rest, .mult, .divi, .doIt, .clear").live('click', function(){
    data = $(this).attr('class');
    switch (data.split(' ')[1]){
        case 'one': 
                $('.Input4').val($('.Input4').val() + 1);
                $('.Input2').val($('.Input2').val() + 1);
                $('.Input').val($('.Input').val() + 1);				
			
            break;
        case 'two':	
                $('.Input4').val($('.Input4').val() + 2);
                $('.Input2').val($('.Input2').val() + 2);
	                $('.Input').val($('.Input').val() + 2);				
			
            break;
        case 'three':	
                $('.Input4').val($('.Input4').val() + 3);
                $('.Input2').val($('.Input2').val() + 3);
	                $('.Input').val($('.Input').val() + 3);					
			
            break;
        case 'four':		
                $('.Input4').val($('.Input4').val() + 4);
                $('.Input2').val($('.Input2').val() + 4);
	                $('.Input').val($('.Input').val() + 4);					
		
            break;
        case 'five':	
                $('.Input4').val($('.Input4').val() + 5);
				$('.Input2').val($('.Input2').val() + 5);
	                $('.Input').val($('.Input').val() + 5);					
			 
            break;
        case 'six':		
                $('.Input4').val($('.Input4').val() + 6);
                $('.Input2').val($('.Input2').val() + 6);
	                $('.Input').val($('.Input').val() + 6);					
			 
            break;
        case 'seven':	
                $('.Input4').val($('.Input4').val() + 7);
                $('.Input2').val($('.Input2').val() + 7);
		           $('.Input').val($('.Input').val() + 7);				
			
            break;
        case 'eith':	
                $('.Input4').val($('.Input4').val() + 8);
                $('.Input2').val($('.Input2').val() + 8);
	                $('.Input').val($('.Input').val() + 8);					
		
            break;
        case 'nine':
                $('.Input4').val($('.Input4').val() + 9);
                $('.Input2').val($('.Input2').val() + 9);
        ...
        case 'divi':
                 ...
                 $('.Input4').val($('.Input4').val() + " % ");
				 $('.Input3').val($('.Input3').val() + "porcentaje");
		   if($('.Input3').val() == "porcentaje"){
				var final = parseInt(eval($('.Input2').val()));
				var final1 = (precioField.text() - parseInt(final/100));
				$('.Input').val(' ');
                $('.Input').val(final1);
		   }
		   else{
        ...
        case 'doIt':	
		   if($('.Input3').val() == "porcentaje"){
			    ...
			    $('.Input').val(eval($('.Input4').val()));
				 $('.Input4').val(eval($('.Input4').val()));
			  }
...
$(document).ready(function(){
        ...
        function formatRows(row){
            ...
            html += "<p><span class='stock'>Stock: "+row.stock_minimo+"</span>&nbsp;<input type='hidden' value='"+row.precio_compra+"' class='precio-compra-real'/><span class='precio-minimo'>C&oacute;digo de barra: "+row.codigo+"</span></p><input type='hidden' class='id_producto' value='"+row.id+"'/><input type='hidden' class='codigo' value='"+row.codigo+"'><input type='hidden' class='impuesto' value='"+row.impuesto+"'></td></tr>";
            return html;
        }
 ...
 var lista_clientes = {
    ...
    init:function(){
        ...
        for (var i = 0; i < this.prototype.length; i++) {
            li = li + "<li value='"+(i)+"' onclick='lista_clientes.select(this)'><a href='#'  class='clienteHideButton'>"+this.prototype[i].nombre_comercial+"</a></li>";
        };
...
function renderFactura(){
    ...
    if(matching == -1){
        ...
        rowHtml += "<td><span class='label label-success cantidad'>"+1+"</span></td>";
        rowHtml += "<td><span class='label label-success precio-prod'>"+sProduct.precio_venta+"</span><input type='hidden' class='precio-prod-real' value='"+sProduct.precio_venta+"'/><input type='hidden' class='precio-prod-real-no-cambio' value='"+sProduct.precio_venta+"'/></td>";
